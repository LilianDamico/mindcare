 ...
 */
@Generated
public class MindcareApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new MindcareApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new MindcareApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
